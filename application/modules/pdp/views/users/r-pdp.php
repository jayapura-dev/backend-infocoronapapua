  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-header-right">
        ...
        <a href="<?php echo base_url()?>Pdp/user_print_pdp" title="Print" target="_blank"><i class="icofont icofont-printer"></i></a>
        <a href="<?php echo base_url()?>Pdp/user_create_pdp" title="Tambah Data"><i class="icofont icofont-plus-square"></i></a>
      </div>
    </div>
              ...
              <td>
                <div class="btn-group dropdown-split-primary">
                  ...
                  <a data-toggle="modal" class="dropdown-item waves-effect waves-light" href="" data-target="#update_pdp" onclick="updatepdp(
                    ...
                    <a class="dropdown-item waves-effect waves-light" href="<?php echo base_url()?>Pdp/user_delete_pdp/<?php echo $item->id_pdp ?>">Delete</a>
                </div>
                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <?php $this->load->view('pdp/users/u-pdp') ?>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="alert alert-primary icons-alert">
               ...
               <?php $this->load->view('pdp/users/pdp_sent_suspect') ?>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default waves-effect btn-sm " data-dismiss="modal">Close</button>
            </div>
