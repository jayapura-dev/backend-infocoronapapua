      ...
      <tbody>
        ...
        foreach($kabkota as $item){ ?>
          <tr>
            ...
            <td class="text-center"><?php echo $item->odp ?></td>
			<td class="text-center"><?php echo $item->pdp ?></td>
            <td class="text-center"><?php echo $item->confirm ?></td>
            <td class="text-center"><?php echo $item->positif ?></td>
            <td class="text-center"><?php echo $item->sembuh ?></td>
            <td class="text-center"><?php echo $item->meninggal ?></td>
          </tr>
      <?php } ?>
      </tbody>
  	</table>
