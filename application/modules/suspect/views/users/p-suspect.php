...
<?php 
$nama_kab = $this->session->userdata('nama_lengkap') 
?>
...
<div id="container">
  	...
  	<div class="title">
  		<table width="100%">
  		<tr>
          <td colspan='2' align='center'><text class="lg-text">PROVINSI PAPUA</text></td></tr>
          <td colspan='2' align='center'><text class="lg-text"><?php echo $nama_kab ?></text></td>
        </tr>
  	  </table>
      <hr/>
      <table width="100%">
        <tr><td colspan='2' align='center'>DATA PASIEN TERKONFIRMASI (SUSPECT)</td></tr>
      </table>
      ...
      <tbody>
        ...
        foreach($suspect as $item){ ?>
          <tr>
            ...
            <td class="text-center"><?php echo $item->kontak ?></td>
			<td class="text-center"><?php echo $item->rumah_sakit ?></td>
