  ...
  <div class="card">
    ...
    <i class="icofont icofont-boy"></i> <i class="icofont icofont-girl-alt"></i><strong> DATA PASIEN SUSPECT (POSITIF) COVID 19 </strong>
      <div class="card-header-right">
        ...
        <a href="<?php echo base_url()?>Suspect/user_print_suspect" title="Print" target="_blank"><i class="icofont icofont-printer"></i></a>
        <a href="<?php echo base_url()?>Suspect/user_create_suspect" title="Tambah Data"><i class="icofont icofont-plus-square"></i></a>
      </div>
    </div>
              ...
              <td>
                <div class="btn-group dropdown-split-inverse">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item waves-effect waves-light" href="<?php echo base_url()?>Suspect/user_delete_suspect/<?php echo $item->id_suspect ?>">Delete</a>
                </div>
              </td>
            </tr>
            <?php } ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <?php $this->load->view('suspect/users/u-suspect') ?>
            </div>
