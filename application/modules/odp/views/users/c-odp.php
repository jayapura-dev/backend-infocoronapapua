    ...
    <div class="col-sm-12">
       <div class="card">
         ...
         <div class="card-block">
           ...
           <form method=post action="<?php echo base_url()?>Odp/user_create_odp_post">
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nama</label>
                <div class="col-sm-10">
                  <input type="text" name="nama" class="form-control">
                  <input type="hidden" name="id_kabupaten" value="<?php echo $this->session->userdata('id_kabupaten') ?>" class="form-control">
                </div>
              </div>
              <div class="form-group row">
