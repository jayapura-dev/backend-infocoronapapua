...
<head>
    <title>BACKEND | Kawal Corona Papua </title>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo base_url()?>assets\backend\icon/coronaicon1.png" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets\backend\icon\themify-icons\themify-icons.css">
    <!-- ico font -->
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h4 class="text-center">Login | Backend</h4>
                                        </div>
                                    </div>
...
<![endif]-->
    ...
    <script type="text/javascript" src="<?php echo base_url()?>assets\backend\js\common-pages.js"></script>
